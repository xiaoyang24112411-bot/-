...
/深度联网问 问题　联网搜索 + 深度推理
/记忆清除　清空自己的上下文
看图 + 图片／回复图片｜/问 问题 + 图片　DeepSeek 看图理解
设置人格 内容｜查看人格｜重置人格
@机器人 内容　按小鲸鱼人格结合群聊回答（需开启；峰价策略由终极管理员控制）
...
随机排序 A | B | C
发起投票 吃什么 | 火锅 | 烧烤
投票 编号 选项编号｜投票结果 编号｜投票列表
结束投票 编号（发起者、群管理或终极管理员）
...
【机器人终极管理员】
拉黑 QQ号｜拉黑 @群友｜解除拉黑 QQ号｜放出 @群友（全局生效）
黑名单 [页码]（仅终极管理员可管理）
/开启自主回答｜/关闭自主回答｜/自主回答状态
开启高峰期自主回答｜关闭高峰期自主回答｜高峰期自主回答状态（仅本群）
开启表情包自主发送｜关闭表情包自主发送（仅本群）
